...
export default function NotificationBell({ userId, onLink }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="fixed left-2 right-2 top-14 sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-80 max-h-[70vh] overflow-y-auto bg-card border border-border shadow-lg z-50">
